  ...
  return (
    <main className="min-h-screen bg-zinc-950 overflow-hidden">
      <section className="relative px-4 pt-24 pb-20 text-center">
        ...
        <div className="relative">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link href="/register" className="bg-yellow-400 hover:bg-yellow-300 text-zinc-900 font-black px-8 py-4 rounded-2xl text-lg transition-all hover:scale-105 active:scale-95 glow-yellow">
              Jouer maintenant →
            </Link>
            <Link href="/login" className="bg-zinc-900 hover:bg-zinc-800 border border-zinc-700 text-white font-bold px-8 py-4 rounded-2xl text-lg transition-colors">
              Se connecter
            </Link>
          </div>
        </div>
      ...
      <section className="px-4 py-20 text-center">
        ...
        <Link href="/register" className="inline-block bg-yellow-400 hover:bg-yellow-300 text-zinc-900 font-black px-10 py-4 rounded-2xl text-xl transition-all hover:scale-105">
          Créer mon compte 🎲
        </Link>
      </section>
